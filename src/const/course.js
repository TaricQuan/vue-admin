...
export const getUserInfo = (params) => axios.get(host+"/school/backend/user/userinfo",{params});//用户信息

export const getSchoolInfo = (params) => axios.get(host+"/school/backend/school/basicinfo",{params});//学校基本信息接口
